...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location:../allfolders/index1.php");
    exit;
}
                        ...
                        echo "<script type='text/javascript'>
                            ...
                            if(password_verify($password, $hashed_password)){
                                ...
                                $email_err= "<script type='text/javascript'>
                                    swal({
                                        title: 'Opps...!',
                                        text: 'Your Userid or Password is incurrect!',
                                        icon: 'error',
                                    });
                                    </script>";
...
<body>
    <div class="wrapper container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="group">
                <input id="check" type="checkbox"  required class="check" checked>
                <label for="check"><span class="icon"></span> Keep me Signed in</label>
             </div>
            <div class="form-group">
                <input type="submit" name="login" class="btn btn-primary" value="Login" onclick="popup()">
            </div>
