        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
								<li><a href="homepage/shop.html">Horticulture</a></li>
								<li><a href="homepage/shop-detail.html">Vagitables Farming</a></li>
                                <li><a href="homepage/cart.html">Rice & Wheat Cultivition</a></li>
                                <li><a href="homepage/checkout.html">Tea & Jute Cultivition</a></li>    
                            </ul>
                        </li>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="homepage/images/img-pro-01.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Carrot</a></h6>
                            <p>1kg - <span class="price">₹ 80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="homepage/images/img-pro-02.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Cheery</a></h6>
                            <p>1kg - <span class="price">₹ 60.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="homepage/images/img-pro-03.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Agam facilisis</a></h6>
                            <p>1kg - <span class="price">₹ 40.00</span></p>
                        </li>
                        <li class="total">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Services</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="../index1.php">Go to Home</a></li>
